...
data_lm <- lm(data$unemployed ~ data$DECK_COND_058 + data$SUPERSTRUCTURE_COND_059 + 
                      data$SUBSTRUCTURE_COND_060)
summary(data_lm)

```

The multiple R-squared value is 0.04671, and the adjusted R-squared value is 0.03657 with a p value of 
p = 1.313e-15. While highly significant, this indcates that the combined variables superstructure
condition, substructure condition, and deck condition in 2018 only explain at best 4.671% of the variation in unemployment in Maine in 2019. It is possible that the condition of the bridge was not the deciding factor when labor forces were allocated in Maine.
